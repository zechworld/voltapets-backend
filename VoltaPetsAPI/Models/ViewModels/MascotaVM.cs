...
namespace VoltaPetsAPI.Models.ViewModels
{
    ...
    {        
        ...
        [Required(ErrorMessage = "La imagen de la mascota es obligatoria")]
        public Imagen imagen { get; set; }

        //FK Sexo
        [Required(ErrorMessage = "No se recibió codigo sexo")]
        public int? CodigoSexo { get; set; }

        //FK Tamanio
        [Required(ErrorMessage = "No se recibió codigo tamaño")]
        public int? CodigoTamanio { get; set; }

        //FK Raza
        [Required(ErrorMessage = "No se recibió codigo raza")]
